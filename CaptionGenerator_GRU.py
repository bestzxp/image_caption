...
class Caption_Generator():
    def __init__(self, dim_in, dim_embed, dim_hidden, batch_size, n_lstm_steps, n_words, mode="test", init_b=None,lstm_dropout_keep_prob=0.7):
        ...
        self.lstm = tf.contrib.rnn.GRUCell(dim_hidden)
